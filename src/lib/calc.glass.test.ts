    ...
    const [score, result] = calculate(
      ...
      1080,
      {
        bench: [
          ...
          { kind: 'glass', grade: 1, level: 1 },
          { kind: 'glass', grade: 2, level: 0 },
          'locked',
          'locked',
          'locked',
        ],
  ...
  it('round5', () => {
    const [score, result] = calculate(
      ...
      21141,
      {
        bench: [
          { kind: 'glass', grade: 0, level: 2 },
          { kind: 'glass', grade: 1, level: 2 },
          { kind: 'glass', grade: 2, level: 2 },
          { kind: 'sand', grade: 1, level: 0 },
          'locked',
          'locked',
        ],
